    ...
    <div class="main-wrapper">
      ...
      <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{route('admin.dashboard')}}">Indoexpress</a>
          </div>
          ...
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>  
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Data Pelabuhan</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="index-0.html">Amerika</a></li>
                  <li><a class="nav-link" href="index.html">Belanda</a></li>
                  <li><a class="nav-link" href="index.html">Jepang</a></li>
                  <li><a class="nav-link" href="index.html">Indonesia</a></li>
                </ul>
              </li>
              <li><a class="nav-link" href="{{ route('admin.data_container')}}"><i class="far fa-square"></i> <span>Data Kontainer</span></a></li>
              <li><a class="nav-link" href="{{ route('admin.data_kapal')}}"><i class="far fa-square"></i> <span>Data Kapal Cargo</span></a></li>
              <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Data Pengiriman Barang</span></a></li>
              <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Tracking Pengiriman</span></a></li>
        </ul>
      </aside>
      <!-- /SIDEBAR -->
      </div>-
